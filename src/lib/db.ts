...
export const FALLBACK_SETTINGS: SiteSettings = {
  ...
  hero_tagline: 'Skulptur, offentlig konst, akvareller och scenografi sedan 1957',
  ...
  contact_hero_image: 'https://ixlvwwllvpweltntbsou.supabase.co/storage/v1/object/public/images/wp/contact/siverts-alper.jpg',
  contact_intro: '',
  og_title: '',
  og_description: '',
