...
const COMMISSION_SLUG_MAP: Record<string, string> = {
  'Bronsgaller, Dagens Nyheter':           'dagens-nyheter-1965',
  'Garnisonen':                            'garnisonen-1972',
  'Fersenska palatset, Handelsbanken':     'fersenska-palatset-1975',
  'Västra skogen T-banestation':           'vastra-skogen-1975',
  'Riksbyggen/Göta Ark, Medborgarplatsen': 'medborgarplatsen-1984',
  'Pharmacia entréplats':                  'pharmacia-1984',
  'Tetra Pak':                             'tetra-pak-1984',
  'Göteborgs Universitetsbibliotek':       'gu-biblioteket-1985',
  'Uppsala Stadsbibliotek':                'uppsala-stadsbibliotek-1986',
  'Stockholms Universitet Campus':         'frescati-1987',
  'Skissernas Museum, fasad':              'skissernas-museum-1988',
  'SAS Huvudkontor, Frösundavik':          'sas-huvudkontor-1988',
  'Blasieholmstorg — Hästar i brons':     'blasieholmstorg-1989',
  'Sveriges ambassad, entré':              'ambassad-tokyo-1990',
  'Berns Ljusgård':                        'berns-1991',
  'SEB Banken Huvudkontor':                'seb-banken-1992',
  'Haga Norra gångbro':                    'haga-norra-1993',
  'Nobel Forum':                           'nobel-forum-1993',
  'Cavallobrunnen, Resecentrum':           'skovde-1995',
  'Kungsträdgården, norra delen':          'kungstradgarden-1997',
  'Synagoga förintelsenmonumentet':        'synagogan-1998',
  'Sergels torg — Sergel monumentet':      'sergels-torg-1998',
  'Kungliga Biblioteket':                  'kungliga-biblioteket-1998',
  'Potatisåkern — Profilen':               'potatisackern-2001',
  'Eskilstuna rondellen — Profilen':       'eskilstuna-2002',
  'Gustav Adolfs torg, fontäner':          'gustav-adolfs-torg-2002',
  'Nobelmonument':                         'nobelmonument-new-york-2003',
  'Roslagens Sparbank':                    'roslagens-sparbank-norrtalje-2004',
  'Bältesspännarparken':                  'baltesspaennarparken-2013',
}
