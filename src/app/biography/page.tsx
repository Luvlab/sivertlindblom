...
export const metadata: Metadata = { title: 'Biografi' }
  ...
  return (
    <div className="section-gap">
      ...
      <div className="page-pad" style={{ marginBottom: '3rem' }}>
        <p style={{ fontSize: 'var(--fs-xs)', letterSpacing: '0.14em', textTransform: 'uppercase', color: 'var(--color-accent)', marginBottom: '0.75rem' }}>Biografi</p>
        <h1 style={{ fontFamily: 'Georgia, serif', fontWeight: 400, fontSize: 'clamp(1.8rem,4vw,3rem)', marginBottom: '1rem' }}>Sivert Lindblom</h1>
        <p style={{ color: 'var(--color-muted)', maxWidth: '65ch', fontSize: 'var(--fs-base)', lineHeight: 1.8 }}>
          Sivert Lindblom (f. 1931 i Husby-Rekarne, Södermanland) är en av Sveriges mest betydande skulptörer.
          Han studerade vid Kungliga Konsthögskolan i Stockholm 1958–1963 och har sedan dess skapat ett omfattande
          verk av skulpturer, offentliga installationer, akvareller och scenografi. Tidigt influerad av Rodin,
          utvecklade han ett eget formspråk kring klassiska geometriska former — cirkeln, sfären, pyramiden, kuben.
        </p>
      </div>
      ...
      <div className="page-pad" style={{ paddingTop: '3rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%,480px),1fr))', gap: '4rem' }}>
          ...
          {/* Timeline */}
          <section>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'var(--fs-2xl)', marginBottom: '2rem' }}>Kronologi</h2>
            {TIMELINE.map((t, i) => (
          ...
          {/* Group exhibitions */}
          <section>
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'var(--fs-2xl)', marginBottom: '2rem' }}>Grupputställningar i urval</h2>
      ...
      {/* Public commissions — text-columns on wide */}
      <section className="page-pad" style={{ paddingBottom: '5rem' }}>
        <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'var(--fs-2xl)', marginBottom: '2rem' }}>Offentliga uppdrag i urval</h2>
        <div>
